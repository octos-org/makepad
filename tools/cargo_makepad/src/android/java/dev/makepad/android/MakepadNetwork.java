    ...
    public CompletableFuture<HttpResponse> performHttpRequest(String url, String method, String headers, byte[] body) {
        return CompletableFuture.supplyAsync(() -> {
            ...
            try {
                ...
                // Route app-initiated requests through the configured proxy (set as
                // the standard JVM proxy system properties by the native layer when
                // launched with makepad.OCTOS_PROXY). We apply it explicitly rather
                // than relying on the default ProxySelector picking the properties up.
